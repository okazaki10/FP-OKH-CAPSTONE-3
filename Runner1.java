...
public class Runner1 extends Thread {
    ...
    public void run() {
        ...
        RandomMetaheuristic RMH = new RandomMetaheuristic(conflictMatrix, timeslot, itr, minimumTimeslot,
                course.getStudentData());
        RMH.tampil = tampil;
        long startTimeRMH = System.nanoTime();
        System.out.println(
                namadataset + " Optimized Timeslots with Random Meta Heuristic Algorithm : " + RMH.optimizeTimeslot());
        ...
        System.out.println(namadataset + " Final penalty = " + penaltyRMH);
        System.out.println(namadataset + " Delta = " + delta + "%");
        System.out.println(namadataset + " Random Meta Heuristic execution time in miliseconds : " +
                timeElapsedRMH / 1000000);
    }
}